terraform {
  source = "${get_env("TG_ROOT_DIR", "/terragrunt")}/modules/aws//default_network_acl"
}
...
dependency "vpc" {
  ...
  mock_outputs = {
    id                     = "fake-vpc-id"
    name                   = "fake-vpc-name"
    default_network_acl_id = "fake-default-nacl"
  }
}
...
inputs = {
  ...
  default_network_acl_id = dependency.vpc.outputs.default_network_acl_id
