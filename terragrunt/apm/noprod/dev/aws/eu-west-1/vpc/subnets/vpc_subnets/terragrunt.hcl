terraform {
  source = "${get_env("TG_ROOT_DIR", "/terragrunt")}/modules/aws//subnets"
}
...
inputs = {
  ...
  private_subnets = local.common_vars.vpcs_vpc_private_subnets
  public_subnets  = local.common_vars.vpcs_vpc_public_subnets
